     ...
     (defined(__INTEL_COMPILER) && (__INTEL_COMPILER >= 1200)))
      do_call_finish_edge</*
        has_member_function_finish_edge<Vis, void,
          boost::mpl::vector<E, const G&> >::value*/true>::call_finish_edge(vis, e, g);
//      std::cout<<"has_member_function_finish_edge<Vis, void>::value"<<has_member_function_finish_edge<Vis, void>::value;
#else
